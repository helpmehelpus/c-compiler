...
// default callbacks for resolver
...
// This is where the "inheritance"-like behaviour is implement, i.e., we pass callbacks here that implement the functions
// We do it by passing pointers to functions declared in this file
