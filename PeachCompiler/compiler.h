...
struct datatype {
    ...
    struct array
    {
        ...
        /**
         * size equal size of datatype by total array indexes
         * e.g. int a[1][2] has size 4 * 1 * 2
         */
        size_t size;
    } array;
};
...
struct lex_process *
lex_process_create(struct compile_process *compiler, struct lex_process_functions *functions, void *private);
