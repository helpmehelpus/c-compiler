...
#define EXPRESSION_UNINHERITABLE_FLAGS ( \
        ...
        EXPRESSION_LOGICAL_AND | EXPRESSION_IN_LOGICAL_EXPRESSION |       \
        EXPRESSION_IS_BITSHIFT_LEFT | EXPRESSION_IS_BITSHIFT_RIGHT | EXPRESSION_IS_BITWISE_OR |                     \
        EXPRESSION_IS_BITWISE_AND | EXPRESSION_IS_BITWISE_XOR | EXPRESSION_IS_ASSIGNMENT | IS_ALONE_STATEMENT)
...
struct datatype* datatype_is_a_pointer(struct datatype* d1, struct datatype* d2);
